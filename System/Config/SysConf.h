...
#define RAM_SIZE    (8 * 1048576)

#define NORMAL_STACK_ADDR   (RAM_BASE + RAM_SIZE - 4)
#define IRQ_STACK_ADDR      (NORMAL_STACK_ADDR  - 200 * 4)
#define SWI_STACK_ADDR      (IRQ_STACK_ADDR     - 200 * 4)
#define KERNEL_HEAP_END     (SWI_STACK_ADDR - 200 * 4)
